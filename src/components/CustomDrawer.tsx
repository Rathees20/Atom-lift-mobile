...
const CustomDrawer: React.FC<CustomDrawerProps> = ({ onClose, onLogout, onNavigateToComplaint, onNavigateToMaterialRequisition, onNavigateToLeave, onNavigateToTravelling, onNavigateToAddCustomer, onNavigateToCreateAMC, onNavigateToViewAttendance, onShowTips, mobileNumber }) => {
